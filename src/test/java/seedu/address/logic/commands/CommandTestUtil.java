...
public class CommandTestUtil {
    ...
    public static final String VALID_DAYPARAM_AMY = "11111111";
    public static final String VALID_DAYPARAM_BOB = "22222222";
    ...
    public static final String DAYPARAM_DESC_AMY = " " + PREFIX_DAYPARAM + VALID_DAYPARAM_AMY;
    public static final String DAYPARAM_DESC_BOB = " " + PREFIX_DAYPARAM + VALID_DAYPARAM_BOB;
    ...
    public static final String INVALID_DAYPARAM_DESC = " " + PREFIX_DAYPARAM + "911a"; // 'a' not allowed in day params
    ...
    static {
        DESC_AMY = new EditRecordDescriptorBuilder().withName(VALID_NAME_AMY)
                .withDayParam(VALID_DAYPARAM_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditRecordDescriptorBuilder().withName(VALID_NAME_BOB)
                .withDayParam(VALID_DAYPARAM_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
