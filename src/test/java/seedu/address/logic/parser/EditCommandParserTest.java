...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_DAYPARAM_DESC, DayParam.MESSAGE_DAYPARAM_CONSTRAINTS); // invalid phone
        ...
        assertParseFailure(parser, "1" + INVALID_DAYPARAM_DESC + EMAIL_DESC_AMY, DayParam.MESSAGE_DAYPARAM_CONSTRAINTS);

        // valid phone followed by invalid phone. The test case for invalid phone followed by valid phone
        // is tested at {@code parse_invalidValueFollowedByValidValue_success()}
        assertParseFailure(parser, "1" + DAYPARAM_DESC_BOB + INVALID_DAYPARAM_DESC, DayParam.MESSAGE_DAYPARAM_CONSTRAINTS);
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_ADDRESS_AMY + VALID_DAYPARAM_AMY,
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + DAYPARAM_DESC_BOB + TAG_DESC_HUSBAND
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND;

        EditRecordDescriptor descriptor = new EditRecordDescriptorBuilder().withName(VALID_NAME_AMY)
                .withDayParam(VALID_DAYPARAM_BOB).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
    ...
    public void parse_someFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + DAYPARAM_DESC_BOB + EMAIL_DESC_AMY;

        EditCommand.EditRecordDescriptor descriptor = new EditRecordDescriptorBuilder().withDayParam(VALID_DAYPARAM_BOB)
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // phone
        userInput = targetIndex.getOneBased() + DAYPARAM_DESC_AMY;
        descriptor = new EditRecordDescriptorBuilder().withDayParam(VALID_DAYPARAM_AMY).build();
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_FIRST_RECORD;
        String userInput = targetIndex.getOneBased() + DAYPARAM_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
                + TAG_DESC_FRIEND + DAYPARAM_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY + TAG_DESC_FRIEND
                + DAYPARAM_DESC_BOB + ADDRESS_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_HUSBAND;

        EditRecordDescriptor descriptor = new EditRecordDescriptorBuilder().withDayParam(VALID_DAYPARAM_BOB)
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        Index targetIndex = INDEX_FIRST_RECORD;
        String userInput = targetIndex.getOneBased() + INVALID_DAYPARAM_DESC + DAYPARAM_DESC_BOB;
        EditRecordDescriptor descriptor = new EditRecordDescriptorBuilder().withDayParam(VALID_DAYPARAM_BOB).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // other valid values specified
        userInput = targetIndex.getOneBased() + EMAIL_DESC_BOB + INVALID_DAYPARAM_DESC + ADDRESS_DESC_BOB
                + DAYPARAM_DESC_BOB;
        descriptor = new EditRecordDescriptorBuilder().withDayParam(VALID_DAYPARAM_BOB).withEmail(VALID_EMAIL_BOB)
